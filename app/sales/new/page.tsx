...
export default function SalesPage() {
    ...
    async function handleSubmit() {
        ...
        if (res.success) {
            ...
            router.push(`/sales/invoice/${res.invoiceId}`);
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="flex gap-3 relative">
                                ...
                                {search && productList.length > 0 && (
                                    <div className="absolute w-full top-12 bg-white border shadow z-50 max-h-52 overflow-auto rounded-md">
                                        {productList.map((p) => (
                                            <div
                                                key={p.id}
                                                onMouseDown={() =>
                    ...
                    <Card className="h-fit sticky top-6">
                        <CardHeader>
                            <CardTitle>
                                <IndianRupee className="inline mr-2" /> Summary
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
                            {items.map((i) => (
